...
export const metadata = {
  ...
  twitter: {
    ...
    title: "InsightRep — AI Google Reviews for Indian Hospitality",
    description: "Turn happy diners ithentic Google reviews in 60 seconds.",
    images: ["/og"],
  },
    ...
    <html lang="en" className={`${geistSans.variable} ${geistMono.variable} h-full antialiased`}>
      <body className="min-h-full flex flex-col bg-navy font-sans text-foreground">
        {children}
          ...
          style={{position:"fixed",bottom:"24px",right:"24px",zIndex:9999,display:"flex",alignItems:"center",justifyContent:"center",width:"56px",height:"56px",borderRadius:"50%",background:"#25D366",boxShadow:"0 4px 24px rgba(37,211,102,0.4)",cursor:"pointer",textDecoration:"none"}}
