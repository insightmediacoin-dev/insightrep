...
<tr><td><table width="100%" cellpadding="0" cellspacing="0" style="max-width:540px;margin:0 auto">
...
<tr><td style="background:#fff;padding:0 32px 20px">
  <div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:16px 20px">
    <p style="margin:0;font-size:13px;color:#166534;line-height:1.6">
      At this pace you are on track for <strong>~${formatNum(monthEst)} reviews this month</strong>.
      ${monthEst >= 20 ? " Keep it up — 4.5+ rating is within reach." : " Increasing QR visibility can double this."}
    </p>
  </div>
</td></tr>
<tr><td style="background:#fff;padding:0 32px 20px">
  <div style="border-left:3px solid #E5322D;padding:12px 16px;background:#fff8f0;border-radius:0 8px 8px 0">
    <p style="margin:0;font-size:13px;color:#444;line-height:1.6"><strong style="color:#E5322D">Tip:</strong> ${tip}</p>
  </div>
</td></tr>
<tr><td style="background:#fff;padding:0 32px 28px;text-align:center">
  <a href="https://qr.insightmedia.co.in/dashboard" style="display:inline-block;background:#E5322D;color:#fff;text-decoration:none;border-radius:50px;padding:13px 32px;font-size:14px;font-weight:700">View Dashboard →</a>
</td></tr>
<tr><td style="background:#f9f9f9;border-radius:0 0 16px 16px;padding:20px 32px;text-align:center">
  <p stymargin:0;font-size:11px;color:#aaa">InsightRep · By Insight Media · Chh. Sambhajinagar<br>
  <a href="https://qr.insightmedia.co.in" style="color:#E5322D;text-decoration:none">qr.insightmedia.co.in</a> · WhatsApp: <a href="https://wa.me/917387609098" style="color:#E5322D;text-decoration:none">+91 73876 09098</a></p>
</td></tr>
</table></td></tr></table>
</body></html>`;
}
...
onst { data: businesses, error } = await admin
    .from("businesses")
  ...
  for (const biz of emailOwners) {
    try {
      ...
      results.push({ business: biz.name, ok: !sendError, error: sendError?.message });
