  ...
  return (
    <div className="min-h-[100dvh] bg-navy px-4 py-10 sm:py-16">
      <div className="mx-auto max-w-3xl space-y-12">
        ...
        <header>
          <Link href="/" className="text-sm font-medium text-text-muted hover:text-white">Back to Home</Link>
          <div className="mt-6">
            <p className="text-xs font-bold uppercase tracking-widest text-accent">InsightRep</p>
            <h1 className="mt-2 text-3xl font-bold text-white">Terms and Privacy Policy</h1>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4 text-sm leading-relaxed text-text-muted">
            <div><h3 className="font-semibold text-white mb-1">1. Acceptance of Terms</h3><p>By accessing or using InsightRep, you agree to be bound by these Terms. InsightRep is operated by Insight Media, Chh. Sambhajinagar, Maharashtra, India.</p></div>
            ...
            <div><h3 className="font-semibold text-white mb-1">4. Acceptable Use</h3><p>You agree not to use the Service to generate fake or fraudulent reviews. AI-generated suggestions help customers express genuine experiences only. Misuse results in immediate termination without refund.</p></div>
            <div><h3 className="font-semibold text-white mb-1">5. Google Reviews Policy Compliance</h3><p>Customers read, select, and post review suggestions themselves. This complies with Google review policies as customers post their own genuine experiences.</p></div>
            <div><h3 className="font-semibold text-white mb-1">6. Subscription and Payments</h3><p>Monthly Plan: Rs.1,499/month. Annual Plan: Rs.12,990/year. Monthly plans cancel with 7 days notice. Annual plans are non-refundable after 7 days. Payments processed via Razorpay.</p></div>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4 text-sm leading-relaxed text-text-muted">
            <div><h3 className="font-semibold text-white mb-1">1. Information We Collect</h3><ul className="mt-2 space-y-1 list-disc list-inside"><li>Business owner phone number or email for authentication</li><li>Business details: name, address, Google review link, keywords, products</li><li>Usage data: QR scan counts, review generation counts</li><li>Device info: user agent, referrer URL for analytics only</li></ul></div>
            <div><h3 className="font-semibold text-white mb-1">2. Customer Data</h3><p>InsightRep does not collect personal information from customers who scan QR codes. Customers interact anonymously with no names, emails, or phone numbers collected.</p></div>
            ...
            <div><h3 className="font-semibold text-white mb-1">4. Third-Party Services</h3><ul className="mt-2 space-y-1 list-disc list-inside"><li>Supabase: database and authentication</li><li>OpenAI: AI review generation</li><li>Resend: email delivery</li><li>Razorpay: payment processing</li><li>Vercel: hosting</li></ul></div>
            <div><h3 className="font-semibold text-white mb-1">5. Data Storage and Security</h3><p>All data stored on secure servers via Supabase with industry-standard encryption. OTPs expire in 10 minutes and are deleted after use.</p></div>
            ...
            <div><h3 className="font-semibold text-white mb-1">8. Cookies</h3><p>InsightRep does not use tracking cookies. Browser localStorage is used solely to maintain your login session. No third-party advertising cookies are used.</p></div>
            <div><h3 className="font-semibold text-white mb-1">9. Contact Us</h3><p>For privacy concerns or data requests, contact Insight Media via WhatsApp at insightmedia.co.in. Located in Chh. Sambhajinagar, Maharashtra, India.</p></div>
          </div>
        </section>

        <footer className="border-t border-white/10 pt-8 text-center">
          <p className="text-xs text-text-muted">2026 InsightRep. By Insight Media. Chh. Sambhajinagar</p>
