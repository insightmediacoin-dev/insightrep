    ...
    <div className="flex flex-col lg:flex-row items-center gap-12 justify-center">
      <div className="flex-shrink-0 flex flex-col items-center">
        <style>{`
          ...
          .card-front {
            background:linear-gradient(145deg,#1a2e50,#0d1b35);
            border:1px solid rgba(255,255,255,0.1);
            box-shadow:18px 18px 60px rgba(0,0,0,0.7),-3px -3px 16px rgba(255,255,255,0.03);
            display:flex; flex-direction:column; align-items:center; padding:24px 20px;
          }
          .card-back {
            background:linear-gradient(145deg,#0d1b35,#08111f);
            border:1px solid rgba(229,50,45,0.25);
            box-shadow:18px 18px 60px rgba(0,0,0,0.7);
          ...
          .card-back::before {
            ...
            background:repeating-linear-gradient(-45deg,transparent,transparent 18px,rgba(229,50,45,0.025) 18px,rgba(229,50,45,0.025) 19px);
            pointer-events:none;
          }
        `}</style>
        ...
        <div className="flip-scene">
          <div className="flip-card">
            <div className="card-face card-front">
              ...
              <div className="bg-white rounded-xl p-3 flex items-center justify-center mb-4 relative z-10" style={{width:148,height:148,boxShadow:"0 8px 32px rgba(0,0,0,0.5)"}}>
            ...
            <div className="card-face card-back">
              <div className="flex items-center justify-center w-16 h-16 rounded-2xl bg-accent mb-5 relative z-10" style={{boxShadow:"0 8px 32px rgba(229,50,45,0.4)"}}>
                <span className="text-white font-bold text-xl">IR</span>
              </div>
              <p className="text-white font-bold text-xl mb-1.5 relative z-10">InsightRep</p>
              <p className="text-white/30 text-xs text-center leading-relaxed mb-6 relative z-10">
